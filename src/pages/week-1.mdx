...
The values that you can place into the student's table are governed by a schema, that you design first.
...
I don't advise that you just copy and past these code blocks in, you will not
learn anything. Instead, you should type the examples in and consider what
