...
<center><img src={passwordImage} width={300} /> </center>
...
<AnswerQuestionDialog question={"Individually, construct a hashing function test bed. How long does md5 and bcrypt (with 10, 15, and 20 hashing rounds) take to run?"} id={questionIDs.find(q => q.count === 5).id}>
We won't break away in groups this week. However, what I would like to do is compare our hashing functions running on a few different pieces of hardware - your computers.
