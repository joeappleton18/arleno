...
<SessionSchedule
  sc={[
    { time: "0 - 10", activity: "Students: Arrive" },
    {
      time: "10 - 20",
      activity:
        "Tutor: Introduces the session, highlighting the importance of avoiding academic misconduct",
    },
    {
      time: "20 - 40",
      activity:
        "Tutor: Shares a [padlett](https://padlet.com/) and introduces task 1",
    },
    {
      time: "40 - 85",
    ...
    {
      time: "85 - end of session",
      activity: "Tutor:  Summarises results of task",
    },
  ]}
/>
