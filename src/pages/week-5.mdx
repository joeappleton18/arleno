...
Break way into your alloted groups. 

- Discuss potential problems that you feel could be a candidate for this assessment .
- Discuss how this problem could be articulated.

<AnswerQuestionDialog question={"List below 1 or 2 model problem statements."} id={questionIDs.find(q => q.count === 2).id}>

- Finally, nominate one team member to write out the problem statement and submit by clicking on this pice of text.
