...
<AnswerQuestionDialog question={"In this document the Mongo Team are stating that 80%-90% of applications don't need multi document transactions. To what extent to you agree or disagree and why?"} id={questionIDs.find(q => q.count === 3).id}>
Multi-Document ACID Transactions | MongoDB Blog. [online] MongoDB. Available at: [https://www.mongodb.com/blog/post/mongodb-multi-document-acid-transactions-general-availability](https://www.mongodb.com/blog/post/mongodb-multi-document-acid-transactions-general-availability) [Accessed 9 Nov. 2020].
