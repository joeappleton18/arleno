...
<SessionSchedule
  sc={[
    ...
    {
      time: "60 - 120",
      activity: "Tutor: Discusses Task Outcome",
    },
    {
      time: " 120 - end of session",
      activity: "Students:  Work on Assessment 1",
    },
  ]}
/>
...
## Task 0 - Complete the thought experiment found in the slides

## Task 1 - Video games make you less smart!

<MuiAlert severity="success">
  <AlertTitle>
    <strong> Task 1  - Can video games make you less smart </strong>
  </AlertTitle>
...
## Task 2 - Obtaining the underlining data
