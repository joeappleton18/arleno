...
Academic, writing on the other hand, consists of longer paragraphs. The reason for this is statements made must be underpinned by evidence. Let's explore this idea by first considering paragraphs, then moving
...
## Task 2 - Identifying problems with paragraphs
