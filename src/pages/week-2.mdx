...
They key take away points, from my own experience and the research discussed above:
...
Imagine reading a book; with much anticipation you thumb to page one and you are confronted with this:
...
First, <a href="https://learn.solent.ac.uk/mod/resource/view.php?id=2770701">Look at the marking schema</a>. Then read, and vote on each project.
...
>
  In your groups, use the framework above (the 5 questions), to come up with a
