...
For me good science was represented by the process hypothesis testing using large quantitative data sets. I thought that research based on qualitative data was less sophisticated. I believe this perception was moulded through my consumption of pop psychology science. Don't get me wrong, I love pop science, it makes research accessible; and this can only be a good thing. My only concern is it supports the idea social based research is looking to develop general universal rules about human behaviour.
...
//https://firebasestorage.googleapis.com/v0/b/computing-notes/o/images%2Fbraun-and-clarke.png?alt=media&token=bd29b742-f7b8-4395-9c30-633bf16a776b
