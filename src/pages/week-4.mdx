...
import MVC from "../public/images/mvc.png";
import MuiAlert from "@material-ui/lab/Alert";

# Week 4 & 5 (in your own time)(Completing the MVC stack)
...
For the next couple of weeks, I will be providing you with a sample application which builds on our wine tasting dataset. I intend to ensure you are all starting with the same code base and will provide you with an up-to-date version the application each week. To get started this week:
